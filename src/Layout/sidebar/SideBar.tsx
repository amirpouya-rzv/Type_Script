    ...
    return (
        <section id="sidebar"
            className={`fixed md:right-0 top-0 h-screen w-app_sidebar_w
               dark:bg-[#1b191f] dark:text-white  text-black md:block border-l bg-white border-red-400 transition-all ${showsidebar ? "right-0" : " -right-app_sidebar_w"}`}>
            ...
            <hr className='border-gray-300 mt-5 dark:border-gray-600 w-9/12 mx-auto' />
            <div>
                <ul>
