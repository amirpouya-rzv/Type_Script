  ...
  return (
    <AnimatePresence>
      {isOpen && (
        ...
        >
          <motion.div
            className="relative bg-white/80 dark:bg-darkgray/90 dark:bg-stone-800 dark:text-white backdrop-blur-md border border-white/20 rounded-2xl w-11/12 max-w-lg shadow-2xl overflow-hidden"
